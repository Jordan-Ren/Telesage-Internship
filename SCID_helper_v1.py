...
for id in data_list:
    data_dict[id] = []
MDE = [4, 4, 1, 1, 2, 1, 1, 2, 1, 2, 1, 2, 3, 1, 3, 1, 4, 1, 1, 1, 1, 2, 1, 3, 1, 1, 4, 3, 2, 2, 1, 2, 4, 3, 4, 3, 2, 3, 2, 1, 1, 3, 4, 1, 2, 3, 1, 1, 3, 1, 1, 1, 2, 1, 1, 1, 4, 2, 1, 1, 1, 4, 1, 1, 2, 1, 1, 1, 3, 1, 1, 2, 4, 2]
for id in data_dict:
    data_dict[id].append(MDE.pop(0))
PDD = [3, 4, 2, 2, 4, 4, 3, 1, 1, 4, 3, 4, 4, 1, 3, 1, 4, 1, 4, 4, 4, 1, 4, 4, 4, 2, 4, 3, 1, 4, 4, 2, 4, 4, 1, 4, 2, 3, 1, 1, 2, 4, 4, 4, 4, 4, 4, 4, 4, 2, 1, 4, 4, 4, 1, 3, 4, 2, 3, 1, 2, 3, 2, 4, 4, 1, 4, 4, 4, 3, 4, 1, 4, 4]
for id in data_dict:
...
# print(data_dict)
# print(ids_to_add)
data_dict[ids_to_add[0]][0] = 1
data_dict[ids_to_add[0]][2] = 3
data_dict[ids_to_add[1]][0] = 3
data_dict[ids_to_add[1]][2] = 3
data_dict[ids_to_add[2]][0] = 3
data_dict[ids_to_add[2]][2] = 3
